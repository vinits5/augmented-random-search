...
def params(argv=None):
	...
	parser.add_argument('--num_steps', type=int, default=1000, help='Steps in each epoch')
	parser.add_argument('--mini_batch_size', type=int, default=100, help='Batch Size for PPO')
	...
	parser.add_argument('--max_frames', type=int, default=1500000, help='Maximum frames for training')
